We use Monte Carlo Tree Search with our own changes. It runs in the simulation stage of each generation. Simulations are based on all possiblie generated [[growingNN/Actions/Actions|Actions]] in given generation . Each rollout is scored by the [[Scoring function]] on the [[Simulation Set]].
