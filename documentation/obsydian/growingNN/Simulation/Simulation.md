...
- [[Simulation Set]] — `sim_train_loader` / `sim_val_loader` used by rollouts; built by `RunningConfig.simulation_set_generator.generate` if the caller did not pass them
