...
Search fields: `simulation_alg`, `simulation_scheduler`, `simulation_score`, `simulation_set_generator`, `simulation_set_size`, `sim_train_loader` / `sim_val_loader` set via `set_simulation_loaders`.
